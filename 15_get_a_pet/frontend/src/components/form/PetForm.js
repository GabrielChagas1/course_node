...
function PetForm({handleSumit, petData, btnText}){
    ...
    return (
        <form onSubmit={submit} className={formStyles.form_container}>
            ...
            <Input text="Nome do Pet" type="text" name="name" placeholder="Digite o nome" value={pet.name || ''} handleOnChange={handleChange} ></Input>
            <Input text="Idade do Pet" type="text" name="age" placeholder="Digite a idade" value={pet.age || ''} handleOnChange={handleChange} ></Input>
            <Input text="Peso do Pet" type="text" name="weight" placeholder="Digite o peso" value={pet.weight || ''} handleOnChange={handleChange} ></Input>
